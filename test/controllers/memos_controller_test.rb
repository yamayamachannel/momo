...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { bank: @memo.bank, title: @memo.title, wallet: @memo.wallet } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { bank: @memo.bank, title: @memo.title, wallet: @memo.wallet } }
